<?php
/**
 * ai.php — główny plik widoku
 * Czyta dane z cache.json (generowanego przez fetch_cache.php via cron)
 *
 * Endpointy:
 *   ai.php          → dashboard HTML
 *   ai.php?xml      → context block XML dla agenta
 *   ai.php?json     → surowe dane JSON
 *   ai.php?refresh  → wymusza ręczny fetch (bez crona, wolniej)
 */
